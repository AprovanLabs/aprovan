/**
 * Timeline message shape used by the vendored buzz scroll/virtualization hooks.
 * Lifted from block/buzz `desktop/src/features/messages/types.ts` (fields the
 * presentational timeline + hooks actually read). Nostr-specific reaction /
 * signer fields retained for upstream API compatibility; Chat adapters may
 * leave them unset.
 */
